                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="marcaProducto" name="marcaProducto" value="<%=listaProductoBuscar!=null?listaProductoBuscar.get(1):""%>" required>
                                </div>
                                
                                <div class="form-group">
                                    <label for="nombreProducto">Nombre</label>
                                    <input type="text" class="form-control" id="nombreProducto" name="nombreProducto" value="<%=listaProductoBuscar!=null?listaProductoBuscar.get(2):""%>" required>
                                </div>
                                
                                <div class="form-group">
                                    <label for="precioCompra">Precio de Compra</label>
                                    <input type="text" class="form-control" id="precioCompra" name="precioCompra" value="<%=listaProductoBuscar!=null?listaProductoBuscar.get(4):""%>" required>
                                </div>
