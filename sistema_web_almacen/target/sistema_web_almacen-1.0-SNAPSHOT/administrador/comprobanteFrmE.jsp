                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="form-group" hidden>
                                    <label for="idComprobante">ID</label>
                                    <input type="text" class="form-control" id="idComprobante" name="idComprobante" value="<%=comprobanteEditar.getIdComprobante()%>" required>
                                </div>
