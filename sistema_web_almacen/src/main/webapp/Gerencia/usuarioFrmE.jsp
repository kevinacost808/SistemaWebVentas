...
<!-- -------------------------------------------------------------------------------------------------------------------------- -->
                ...
                <div class="container-fluid">
                    ...
                    %>
                    <form action="/sistema_web_almacen/SvUsuarioEditar" method="post">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group" hidden>
                                    ...
                                    <input type="text" class="form-control" id="idUsuario" name="idUsuario" value="<%=usuario.getIdUsuario()%>" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="password" name="password" value="<%=usuario.getPassword()%>" required>
                                </div>
                                ...
                                <div class="form-group" hidden>
                                    ...
                                    <input type="text" class="form-control" id="idSucursal" name="idSucursal" value="<%=usuario.getSucursal().getIdSucursal()%>" required>
                                </div>
