    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../../index.html">
                ...
                <div class="sidebar-brand-text mx-3">SB Vend <sup>2</sup></div>
            </a>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nombreCliente" name="nombreCliente" placeholder="">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="imei" name="imei" placeholder="">
                                    <br>
                                    <button class="btn btn-info btn-circle">
                                        <i class="fas fa-fw fa-search"></i>
                                    </button>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="proveedor" name="proveedor">
                                        <option value="CELULANDIA">CELULANDIA</option>
                                        <option value="Otro Proveedor 1">OTRO 1</option>
                                        <option value="Otro Proveedor 2">OTRO 2</option>
                                        <!-- Agrega mÃ¡s opciones de proveedores aquÃ­ si es necesario -->
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="fechaIngreso">Fecha Venta</label>
                                    <input type="datetime-local" class="form-control" id="fechaIngreso" name="fechaIngreso" placeholder="">
                                </div>
                                <div class="form-group">
                                    <label for="precioCompra">Precio de Venta</label>
